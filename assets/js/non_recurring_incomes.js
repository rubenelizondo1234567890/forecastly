/* assets/js/non_recurring_incomes.js */
...
function handleFormSubmit(e) {
    ...
    // Get form data
    const form = document.getElementById('non-recurring-income-form');
                ...
                if (accountId) {
                    return updateAccountInterest(accountId)
                        ...
                        .then(() => {
                            ...
                            setTimeout(() => {
                                window.location.href = '/customer/income/non-recurring/';
                            }, 1500);
                        })
                        .catch(error => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            if (!confirm('Are you sure you want to delete this non-recurring income?')) {
                e.preventDefault();
            }
        });
    });
